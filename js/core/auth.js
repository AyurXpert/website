...
function _injectSecurityMeta() {
  ...
  add({ 'http-equiv': 'Content-Security-Policy',
        content: [
          ...
          "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://abhasbx.abdm.gov.in https://phrsbx.abdm.gov.in https://healthid.abdm.gov.in https://cloudflareinsights.com https://static.cloudflareinsights.com",
