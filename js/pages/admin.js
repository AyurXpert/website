...
async function _renderNcismStaffing() {
  ...
  wrap.innerHTML =
    ...
    +'<div style="padding:10px 16px;background:#f0faf5;border-bottom:1px solid var(--border)">'
      +'<div style="font-size:12px;font-weight:700;color:var(--green-deep);margin-bottom:6px">📋 Faculty Required — Schedule I ('+clinDepts+' teaching depts configured)</div>'
      +'<div style="display:flex;flex-wrap:wrap;gap:20px;font-size:13px;align-items:center">'
        +'<span>Prof/HOD per dept: <strong>'+fac.p+'</strong></span>'
        +'<span>Assoc Prof per dept: <strong>'+fac.a+'</strong></span>'
        +'<span>Asst Prof per dept: <strong>'+fac.b+'</strong></span>'
        +'<span style="border-left:2px solid var(--border);padding-left:16px">Hospital-wide total: <strong>'+facReq+'</strong></span>'
